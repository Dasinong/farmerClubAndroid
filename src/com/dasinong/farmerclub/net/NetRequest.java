...
import com.dasinong.farmerclub.net.NetConfig.Params;
...
import com.dasinong.farmerclub.utils.Logger.LogTag;
...
public class NetRequest {
	...
	public <T> void get(int requestCode, Map<String, String> map, String subUrl, final RequestListener callback, final Class<? extends BaseEntity> clazz) {
	...
	public <T> void requestPost(int requestCode, Map<String, String> map, String subUrl, final RequestListener callback, final Class<? extends BaseEntity> clazz) {
	...
	private <T> void post(int requestCode, String url, final Class<? extends BaseEntity> clazz, final Map<String, String> map, final RequestListener callback) {
	...
	public <T> void upload(final int requestCode, String url, String filePath, final Class<? extends BaseEntity> clazz, final RequestListener callback) {
		...
		// String cookie =
		// SharedPreferencesHelper.getString(DsnApplication.getContext(),
	...
	public <T> void uploadImages(final int requestCode, String url, List<String> paths, String cropName, String disasterType, String disasterName,
			String affectedArea, String eruptionTime, String disasterDist, String fieldOperations, String fieldId, final Class<? extends BaseEntity> clazz,
	...
	public <T> void getWXAccessToken(final int requestCode, String url, String appid, String secret, String code, final Class<? extends BaseEntity> clazz,
			final RequestListener callback) {
		HttpUtils http = new HttpUtils();

		http.send(HttpMethod.GET, url + "appid=" + appid + "&secret=" + secret + "&code=" + code + "&grant_type=authorization_code",
	...
	public <T> void getWXUserInfo(final int requestCode, String url, String access_token, String openid, final Class<? extends BaseEntity> clazz,
			final RequestListener callback) {
		HttpUtils http = new HttpUtils();
